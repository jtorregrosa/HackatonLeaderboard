package eu.nouss.hackatonleaderboard.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(eu.nouss.hackatonleaderboard.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(eu.nouss.hackatonleaderboard.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
